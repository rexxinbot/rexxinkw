...
${numberik} ${prefix}swm author|packname *Premium*
${numberik} ${prefix}take author|packname *Premium*
...
*Random Sound*
${numberik} ${prefix}susu
${numberik} ${prefix}sad
${numberik} ${prefix}SUS
${numberik} ${prefix}laguramah
${numberik} ${prefix}arara
${numberik} ${prefix}brando
${numberik} ${prefix}ararawindah
 ...
 *Opbr / One Piece Sound*
 ${numberik} ${prefix}kamusari
 ${numberik} ${prefix}inugami
 ${numberik} ${prefix}torenedaroyoi
 ${numberik} ${prefix}zehahaha
 ${numberik} ${prefix}orewanaru
 ${numberik} ${prefix}robinkawai
 ${numberik} ${prefix}roomlaw
 ${numberik} ${prefix}konosenso
 ${numberik} ${prefix}kamusariv2
 ${numberik} ${prefix}ararakuzan
 ${numberik} ${prefix}yasakani
 ${numberik} ${prefix}hiken
 ${numberik} ${prefix}daisensekai
 ${numberik} ${prefix}hikenv2
 ${numberik} ${prefix}laughdoffy
...
├❒ ${prefix}attp
├❒ ${prefix}ttp
├❒ ${prefix}swm author|packname *Premium*
├❒ ${prefix}take author|packname *Premium
│❒ ${prefix}fdeface
│❒ ${prefix}amongus 
